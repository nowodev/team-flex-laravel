    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-900 shadow-xl sm:rounded-lg flex flex-col h-[80vh]">
                <!-- Chat Header -->
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-4 scroll">
                    @foreach ($messages->sortBy('created_at') as $message)
                        <div class="flex @if ($message->user_id == auth()->id()) justify-end @else justify-start @endif">
                            <div
                                class="flex items-start max-w-[70%] @if ($message->user_id == auth()->id()) flex-row-reverse @endif">
                                <!-- Avatar -->
                                ...
                                <div class="flex flex-col">
                                    <div
                                        class="flex items-center @if ($message->user_id == auth()->id()) justify-end @else justify-start @endif mb-1 space-x-2">
                                        <span
